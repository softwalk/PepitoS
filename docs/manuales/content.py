...
<h3 id="rep-cobertura">Cifras preliminares, corte de datos y comparativos</h3>
<p>Debajo de los filtros verás <span class="badge b-amber">Cifras preliminares</span> cuando en el periodo hay turnos abiertos (sus ventas y caja cambiarán al cerrar) o <span class="badge b-green">Periodo cerrado</span> cuando todo está cerrado, junto con el <b>corte de datos</b> (hasta qué momento están contadas las cifras), la hora de generación y la versión del cálculo. Si hay dispositivos sin sincronizar, el aviso <b>Información pendiente</b> te lo dice: puede haber ventas todavía en el teléfono; el sistema nunca las inventa. Cuando el periodo anterior no tiene base (por ejemplo, un punto nuevo), el KPI muestra <b>"Sin base comparable"</b> en lugar de un porcentaje engañoso. Las definiciones exactas de cada indicador (qué se cuenta y con qué denominador) están en <code>docs/INDICADORES.md</code>.</p>
