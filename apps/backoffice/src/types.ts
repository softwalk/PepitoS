...
export interface RankingRow { operator: { id: string; name: string; username: string; zone_id: string | null }; rank: number | null; total_cents: number; ranking: { day: { rank: number | null; total_cents: number }; month: { rank: number | null; total_cents: number }; year: { rank: number | null; total_cents: number }; computed_at: string | null } }
...
export interface Point { id: string; name: string; display_name?: string; score?: number | null; address: string | null; lat: number; lng: number; geofence_radius_m: number; zone_id: string | null; open_time: string | null; close_time: string | null; daily_target_cents: number; daily_target_tx: number; is_active: boolean; geo_verified?: boolean; meta?: PointMeta }
