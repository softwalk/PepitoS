...
SETTINGS_SCHEMA: dict[str, dict[str, Any]] = {
    ...
    "cash_float_default_cents": {"type": "int", "default": 50000, "min": 0, "description": "Fondo de caja estándar (centavos) que la app propone al abrir el puesto; el vendedor confirma o corrige lo que recibió"},
